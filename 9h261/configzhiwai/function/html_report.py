...
        @parameter report_cases:接口测试结果记录，字典格式且key不能变，report_cases = {'all_cases':[['WEB理财', '1', '登录', 'login', 'post', 'pass', '详细信息', ''],['WEB理财', '2', '产品列表', 'list', 'post', 'error', '详细信息', '']],'right_cases':[['WEB理财', '1', '登录', 'login', 'post', 'pass', '详细信息', '']],'error_cases':[['WEB理财', '2', '产品列表', 'list', 'post', 'error', '详细信息', '']],'untreaded_cases':[['WEB理财', '3', '测试', 'login', 'post', '/', '详细信息', '']]}
        """
    ...
    def packagedCases(self, export_lable_title, data_key, class_name, pannel_num):
        ...
        cases_packaged = ''
        cases_packaged = ''.join(
            [cases_packaged, '<tr class="{}">\n'.format(class_name), export_lable_title, '</tr>\n'])
    ...
    def genHtmlReport(self, html_template):
        ...
        for data_key in self.report_cases.keys():
            ...
            html = template(html_template, report_title=self.html_title, theme=self.pie_theme,
                            ...
                            sum_untreaded_cases=self.test_info[5], right_sum=self.pie_sum_number['right_sum'],
...
if __name__ == '__main__':
    ...
    report_cases = {'all_cases': [
        ...
        'right_cases': [
            ['理财', '1', '登录', 'login', 'po22222222222222222222222222222st', 'Pass', '详细', case_detail]],
        'error_cases': [
            ['理财', '2', '产品列表', 'list', 'pos5555555555555555555555t', 'Fail', '详细', case_detail]],
        'untreaded_cases': [
            ['WEB理财', '3', '测试', 'login', 'po6666666666666666666666666666666666666666666666666666st', '/',
             '详细', case_detail]]}
    ...
    with open("D:\\HDapi-auto-test\\report\\test_demo.html", 'wb') as f:
        f.write(html.encode('utf-8'))

    # 使用浏览器打开html
    webbrowser.open("D:\\HDapi-auto-test\\report\\test_demo.html")
